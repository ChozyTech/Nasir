	                    	...
	                    	<div class="form-body">
	                    		...
	                    		<div class="row">
				                    ...
				                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="namakriteria" name="namakriteria" class="form-control border-primary" placeholder="Nama Kriteria" value="<?php echo $DataKriteria['Nama']; ?>" disabled />
			                        		</div>
				                        </div>
			                        </div>
		                        </div>
		                        <div class="row">
		                        	<div class="col-md-6">
		                        		<div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												 <textarea class="form-control border-primary" placeholder="Keterangan" rows="5" id="keterangan" name="keterangan" disabled ><?php echo $DataKriteria['Keterangan']; ?></textarea>
											</div>
				                        </div>
		                        	</div>
		                        </div>		                      
	                    		...
	                    		<div class="row">
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="sangattidakmampu" name="sangattidakmampu" class="form-control border-primary" placeholder="Sangat Tidak Mampu" value="<?php echo $DataKriteria['SangatTidakMampu']; ?>" disabled />
				                            </div>
				                        </div>
				                    </div>
				                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="tidakmampu" name="tidakmampu" class="form-control border-primary" placeholder="Tidak Mampu" value="<?php echo $DataKriteria['TidakMampu']; ?>" disabled />
			                        		</div>
				                        </div>
			                        </div>
		                        </div>	
								<div class="row">
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="cukupmampu" name="cukupmampu" class="form-control border-primary" placeholder="Cukup Mampu" value="<?php echo $DataKriteria['CukupMampu']; ?>" disabled />
				                            </div>
				                        </div>
				                    </div>
				                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="sangatmampu" name="sangatmampu" class="form-control border-primary" placeholder="Sangat Mampu" value="<?php echo $DataKriteria['SangatMampu']; ?>" disabled />
			                        		</div>
				                        </div>
			                        </div>
		                        </div>	
								<div class="row">
		                        	<div class="col-md-6">
										...
										<div class="col-md-9">
											<input class="form-check-input" id="aktif" name="aktif" type="checkbox" <?php if($DataKriteria['StatusAktif'] == '1') echo "checked" ?> disabled >	
										</div>
										 </div>
			                       	</div>
		                        </div>
							 ...
							 <div class="form-actions right">
	                                                                        <a href="<?php echo base_url(); ?>masterkriteria"><button type="button" class="btn btn-primary">
                                                Back
                                            </button></a>
	                        </div>
	                    </form>
