...
<div class="content-wrapper">
   ...
   <div class="content-header row">
      <div class="content-header-left col-md-4 col-12 mb-2">
         <h3 class="content-header-title">New Kriteria</h3>
      </div>
	                    	...
	                    	<div class="form-body">
	                    		...
	                    		<div class="row">
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="kodekriteria" name="kodekriteria" class="form-control border-primary" placeholder="Kode Kriteria" value="<AUTO_GENERATE>" required />
				                            </div>
				                        </div>
				                    </div>
				                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="namakriteria" name="namakriteria" class="form-control border-primary" placeholder="Nama Kriteria" required />
			                        		</div>
				                        </div>
			                        </div>
		                        </div>
	                    		...
	                    		<div class="row">
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="sangattidakmampu" name="sangattidakmampu" class="form-control border-primary" placeholder="Sangat Tidak Mampu" required />
				                            </div>
				                        </div>
				                    </div>
				                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="tidakmampu" name="tidakmampu" class="form-control border-primary" placeholder="Tidak Mampu" required />
			                        		</div>
				                        </div>
			                        </div>
		                        </div>	
								<div class="row">
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="cukupmampu" name="cukupmampu" class="form-control border-primary" placeholder="Cukup Mampu" required />
				                            </div>
				                        </div>
				                    </div>
				                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="sangatmampu" name="sangatmampu" class="form-control border-primary" placeholder="Sangat Mampu" required />
			                        		</div>
				                        </div>
			                        </div>
		                        </div>	
								<div class="row">
		                        	<div class="col-md-6">
										...
										<div class="col-md-9">
											<input class="form-check-input" id="aktif" name="aktif" type="checkbox" checked >	
										</div>
										 </div>
			                       	</div>
		                        </div>
