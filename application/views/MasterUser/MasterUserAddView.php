...
<div class="content-wrapper">
   ...
   <div class="content-header row">
      <div class="content-header-left col-md-4 col-12 mb-2">
         <h3 class="content-header-title">New User</h3>
      </div>
		...
		<div class="col-md-12">
	        <div class="card">
	            ...
	            <div class="card-content collpase show">
	                <div class="card-body">
	                    <form class="form form-horizontal" id="edituserform" name="edituserform" role="form" method="post" action="<?php echo base_url(); ?>masteruser/insert">
	                    	<div class="form-body">
	                    		...
	                    		<div class="row">
	                    			<div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="username" name="username" class="form-control border-primary" placeholder="Username" required />
				                            </div>
				                        </div>
				                    </div>
				                    <div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="text" id="nama" name="nama" class="form-control border-primary" placeholder="Nama" required />
			                        		</div>
				                        </div>
			                        </div>
		                        </div>
		                        <div class="row">
		                        	<div class="col-md-6">
			                        	<div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												<textarea class="form-control border-primary" placeholder="Alamat" rows="3" id="alamat" name="alamat" data-parsley-maxlength="255" ></textarea>
			                        		</div>
			                       		</div>
			                       	</div>
			                       	<div class="col-md-6">
				                        <div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
				                            	<input type="email" class="form-control border-primary" placeholder="Email" id="email" name="email"  />
			                        		</div>
				                        </div>
				                    </div>
		                        </div>		                      
		                        <div class="row">
		                        	<div class="col-md-6">
		                        		<div class="form-group row">
				                        	...
				                        	<div class="col-md-9">
												<input type="text" id="nohp" name="nohp" class="form-control border-primary" placeholder="No. HP"  />
				                        	</div>
					                    </div>
