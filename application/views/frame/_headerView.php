...
<head>
    ...
    <meta name="keywords" content="<?php echo $this->config->item('app_name'); ?>">
    <meta name="author" content="">
    <title><?php echo $this->config->item('app_name'); ?> -
            <?php echo ucfirst($this->session->userdata('page')); ?></title>
    <link rel="apple-touch-icon" href="<?php echo base_url(); ?>assets/images/logo/logo.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/images/logo/logo.png">
    <link href="<?php echo base_url(); ?>assets/fonts/css93c2.css?family=Muli:300,300i,400,400i,600,600i,700,700i%7CComfortaa:300,400,700" rel="stylesheet">
